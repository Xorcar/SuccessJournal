...
public class TableDat
{
	...
	String querry = "SELECT s.name, v.mark, v.presence " + "FROM Students as s INNER JOIN Groups as g "
		+ "ON g.groupid = s.groupid " + "AND g.name = '" + groupName + "' "
		+ "LEFT JOIN Visitings as v ON v.studentid = s.studentid " + "AND v.groupid = g.groupid "
	...
	for (String str : strList)
	{
		...
		presence = (split[2].equals("1") ? true : false);
